...
import { buildBracketLineCountByCharacterName } from "../services/game/present-characters-context.js";
...
export async function generateRoutes(app: FastifyInstance) {
  ...
  app.post("/", async (req, reply) => {
    ...
    enterAiAuditContext({
      source: "main_generate",
      chatId: input.chatId,
      metadata: { impersonate: !!input.impersonate },
    });
      ...
      while (true) {
        ...
        if (hasPostWork && combinedResponse && !abortController.signal.aborted) {
          ...
          const lastSavedContent =
            typeof (lastSavedMsg as any)?.content === "string" ? (lastSavedMsg as any).content : "";
          ...
          for (const result of sortedResults) {
            ...
            if (
              ...
              try {
                ...
                // Skipped when the materializer is active (autoMaterializeNpcs=true),
