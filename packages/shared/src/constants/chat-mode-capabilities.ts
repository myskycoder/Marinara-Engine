...
import { BUILT_IN_AGENTS, GAME_MODE_DEFAULT_AGENT_IDS } from "../types/agent.js";
...
/** Gameplay agents (scene/combat) beyond the seeded tracker trio in {@link GAME_MODE_DEFAULT_AGENT_IDS}. */
export const GAME_GAMEPLAY_AGENT_IDS = ["quest", "expression", "combat"] as const;

/** Default built-in agents for game chats: HUD trackers + core gameplay agents. */
export const GAME_AGENT_IDS = [...GAME_MODE_DEFAULT_AGENT_IDS, ...GAME_GAMEPLAY_AGENT_IDS] as const;
